    ...
    <div className="min-h-screen flex items-center justify-center bg-beige-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
          <h2 className="font-display text-2xl font-bold text-brand-black mb-1">Welcome back</h2>
          <p className="text-gray-500 text-sm mb-8">Sign in to your Maven account</p>
